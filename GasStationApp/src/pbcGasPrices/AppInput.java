...
//	Lowest diesel gas price
	public void diesel(){
		...
		for(int d = 0; d < compareDiesel.length; d++){
			...
			else if ((diesel3 < diesel2) && (diesel3 < diesel1)){
...
//	Lowest premium gas price
	public void premium(){
		...
		int [] comparePremium = {premium1, premium2, premium3};
		
		for(int d = 0; d < comparePremium.length; d++){

			premiumArray[d] = comparePremium[d];	
			...
			if ((premium1 < premium2) && (premium1 < premium3)){
				...
				premiumArray[d]= premium1;
				premiumArray[d] = premium2;
			}
			
			else if ((premium2 == premium3) && (premium2 < premium1)){
				
				premiumArray[d] = premium2;
				premiumArray[d] = premium3;
...
//	Display lowest diesel gas price
	public void DisplayOutputDiesel(){
		...
		if (LowestDiesel == diesel1){
			...
			System.out.println(" ");
			System.out.println("Least gas price for premium: " + gasstation1 + " in " + city1 + " , " + gasstation2 + " in " + city2 + " & " + gasstation3 + " in " + city3 + " " + "for " + "$" + diesel1 + " per gallon");
		}
